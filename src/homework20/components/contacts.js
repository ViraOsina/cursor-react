    ...
    return(
        <div className="contact_box">
            <div className="content_box_user">
                <img src={contact_icon} className="user_hw20" alt="user"></img>
                <span>{`${props.contact.firstName} ${props.contact.lastName}`}</span>
                <span className="gender_icon_hw20"> {genderIcon()}</span> 
            </div>
...
const Contacts = () => {
    ...
    return (
        <div className="inner_box_hw20">
            <img src={background} alt="background" className="inner_box_hw20_img"></img>
